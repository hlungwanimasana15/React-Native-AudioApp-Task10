...
const HomeScreen = () => {
  ...
  async function removeRecording(index) {
    const recording = recordings[index];
    console.log(recordings[index]);
    console.log("Start removal operation:", new Date().toISOString());
  ...
  const fetchData = async () => {
    try {
      ...
      const recordSnapshot = await getDocs(query(recordCollection));
  ...
  return (
    <>
      <View style={styles.container}>
        <View>
        <Text style={styles.line}>Ready to make some soundwaves?</Text>
        </View>
